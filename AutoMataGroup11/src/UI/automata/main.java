...
//        
        ...
        String numOfStates = "8";
        String symbols = "{a, b}";
        String transitionFunctions = "{q0=>q1,a};{q0=>q5,b};{q1=>q6,a};{q1=>q2,b};{q2=>q0,a};{q2=>q2,b};{q3=>q2,a};{q3=>q6,b};{q4=>q7,a};{q4=>q5,b};{q5=>q2,a};{q5=>q6,b};{q6=>q6,a};{q6=>q4,b};{q7=>q6,a};{q7=>q2,b};";
       // String transitionFunctions = "{q0=>q1,a};{q0=>q5,b};{q1=>q6,a};{q1=>q2,b};{q2=>q0,a};{q2=>q2,b};{q3=>q2,a};{q3=>q6,b};{q4=>q7,a};{q4=>q5,b};{q5=>q2,a};{q5=>q6,b};{q6=>q6,a};{q6=>q4,b};{q7=>q6,a};{q7=>q2,b}";
        String startState = "\"q0\"";
        String setOfFinalStates = "{q2}";

        int num = Integer.parseInt(numOfStates);
        // check type first 

        String type = checkType(num, symbols, transitionFunctions);

        if (type.contains("NFA")) {
            JOptionPane.showMessageDialog(null, "We cannot minize NFA!", "Message", ERROR);

        } else {
            Automaton2 dfa = NFAtoDFAConverter.buildAutomaton(numOfStates, symbols, transitionFunctions, startState, setOfFinalStates);

            System.out.println("DFA:");
            
            String s = "";
            String s1= "===== DFA original =====\n"+dfa.toString();

            Automaton2 equiFA = NFAtoDFAConverter.convertNFAtoDFA(dfa);
            System.out.println(equiFA.toString());
    ...
    private void btnConstructActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConstructActionPerformed
        ...
        int numstate = Integer.parseInt(numState);
        String type = checkType(numstate, setOfSymbol, transitionFunction);

        if (type.contains("DFA")) {
            /// Keep the same
            JOptionPane.showMessageDialog(null, "It's already a DFA!", "Message", NORMAL);
            System.out.println("I'm alrealy DFA, nothing to do with me!!");

        } else {

            System.out.println("I'm a NFA, construct me please!!");
